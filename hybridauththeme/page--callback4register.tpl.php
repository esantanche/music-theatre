...
<script type="text/javascript">
    function onload() {
        console.debug('@callback4registerpage user: ' + document.getElementById("UserIdOfLoggedInUser").value);
        console.debug('@callback4registerpage window.location.href: ' + window.location.href);
        ...
        window.location.replace("/backend/user/register?destination=callback4register");
    }
</script>
</head>
<body onload="onload();">
